...
Place the following files in analysis/inputs/ (recommended), or edit `in_dir` in each script.
...
- If you need to update figure sizing for journal requirements, edit the plot settings section at the top of each script.
